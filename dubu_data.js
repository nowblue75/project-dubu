...
const PROJECTS = [
    ...
    },
    {
        ...
        "troubleShoot": "Q. 포카치아 반죽이 너무 끈적이고 성형하기 힘들어요.<br>A. [수분 팁 & 폴딩 가이드] 순두부 수분량이 포함된 고수분 반죽입니다. 반죽을 무리해서 치대지 마시고, 손에 올리브오일을 살짝 묻힌 뒤 가볍게 접어주는(폴딩) 동작만으로 기포를 유지해야 오븐 속에서 쫄깃한 식감의 기공이 형성됩니다."
    },
    {
        "id": 5,
        "title": "순두부 황치즈휘낭시에",
...
const INGREDIENT_DICT = {
    ...
    "42": [
        { "name": "강력분 (반죽용)", "base": 180 },
        { "name": "강력분 (탕종용)", "base": 20 },
        { "name": "물 (탕종용)", "base": 100 },
        { "name": "순두부 (물기 짜지 않은 그대로)", "base": 40 },
        { "name": "추가 물", "base": 20 },
        { "name": "올리브오일 (반죽용)", "base": 20 },
        { "name": "이스트", "base": 3 },
        { "name": "소금", "base": 5 },
        { "name": "설탕 (또는 비정제 원당)", "base": 8 },
        { "name": "올리브오일 (토핑용)", "base": 20 },
        { "name": "다진 마늘", "base": 8 },
        { "name": "마늘 슬라이스", "base": 15 },
        { "name": "굵은 소금 (선택)", "base": 1 }
    ],
    "7": [
    ...
    "21": [
        ...
        { "name": "박력분", "base": 180 },
        { "name": "베이킹파우더", "base": 6 },
        { "name": "초코가루 (추가)", "base": 22 },
        { "name": "박력분 (초코 추가)", "base": 18 },
        { "name": "녹차가루 (추가)", "base": 10 },
        { "name": "박력분 (녹차 추가)", "base": 30 },
        { "name": "딸기가루 (추가)", "base": 6 },
        { "name": "박력분 (딸기 추가)", "base": 34 },
        { "name": "다크 커버춰 (초코글레이즈)", "base": 55 },
        { "name": "우유 (초코글레이즈)", "base": 20 },
        { "name": "슈가파우더 (녹차글레이즈)", "base": 60 },
        { "name": "레몬즙 (녹차글레이즈)", "base": 15 },
