...
- [x] **index.html 캐시 버스팅 업데이트**
    - [x] `index.html`에서 `v=6.0` 파라미터 적용
- [x] **dubu_app.js 화보집 HUD 마크업 구현**
    ...
    - [x] 3페이지: 2분할 컷 위에 `[PROCESS MONITORING: 150℃ STEAM BAKING]` 타이틀 및 로딩 게이지바 모션
...
- [x] **최종 검증 및 Git Push**
    - [x] `node -c dubu_app.js` 문법 검증
    - [x] `git add -A && git commit -m "feat: lookbook HUD style redesign" && git push` 순차 실행 및 보고
