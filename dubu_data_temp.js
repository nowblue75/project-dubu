...
const PROJECTS = [
    ...
    },
    {
        ...
        "isInteractive": true,
        "blogUrl": "https://blog.naver.com/project_dubu/224245678910",
        "categories": [
            "teatime",
            "fudgy"
        ],
        "time": "40분",
        "emotionalQuote": "단 한 방울의 수분도 허용하지 않는 수분 박멸 비법으로 완성하는 극강의 쫀득함! 🌿",
        "troubleShoot": "Q. 찰떡처럼 쫀득하지 않고 퍽퍽해요!<br>A. 쑥가루를 섞은 후 최소 1시간 냉장 숙성을 거쳐야 순두부와 가루가 완전히 일체화되어 찰기가 살아납니다."
    },
    {
        "id": 37,
        "title": "순두부 화이트 바크초콜릿",
    ...
    },
    {
        ...
        "categories": ["teatime", "creamy", "butterfree", "flourfree"],
    ...
    },
    {
        ...
        tag: 'Midnight Spooky',
        recipes: [
            { id: 4, title: "순두부 퍼지브라우니", vol: "VOL. 4", img: "[이벤트] 할로윈_20251029/KakaoTalk_20251029_091834561_01.jpg", path: "4. 순두부퍼지브라우니_완/index.html", desc: "진하고 묵직한 다크 초콜릿의 풍미를 담은 웰빙 퍼지 브라우니" },
            { id: 15, title: "순두부 단호박바스크치즈케이크", vol: "VOL. 16", img: "16. 순두부단호박바스크치즈케이크_완/KakaoTalk_20251002_082631387_17.jpg", path: "16. 순두부단호박바스크치즈케이크_완/index.html", desc: "단호박의 달콤함와 바스크 치즈케이크의 부드러움이 공존하는 테이스트" },
            { id: 18, title: "순두부 단호박 찹쌀빵", vol: "VOL. 19", img: "19. 순두부 단호박 찹쌀빵_완/KakaoTalk_20251002_083711682.jpg", path: "19. 순두부 단호박 찹쌀빵_완/index.html", desc: "겉은 바삭하고 속은 쫄깃한 황금빛 단호박 슬라이스 브레드" },
            { id: 9, title: "순두부 브라우니쿠키", vol: "VOL. 10", img: "10. 순두부 브라우니쿠키_완/12.jpg", path: "10. 순두부 브라우니쿠키_완/index.html", desc: "쿠키의 바삭함과 브라우니의 쫀득함을 동시에 구현한 듀얼 텍스처" }
        noButter: false,
        oneBowl: false, isInteractive: true, path: "21. 순두부슈톨렌_완/index.html", img: "21. 순두부슈톨렌_완/0.jpg", blogUrl: "https://blog.naver.com/project_dubu/224083029266", categories: ["gift", "cloud"], time: "45분" },
    { id: 19, title: "투톤 순두부 타르트",
        noOven: false,
        noFlour: true,
        noButter: true,
        oneBowl: true, isInteractive: true, categories: ["teatime", "creamy"], time: "45분" , blogUrl: ""},
    { id: 18, title: "순두부 단호박 찹쌀빵",
    },
    {
        "id": 30,
        "title": "순두부 미니초코케익",
    ...
    },
    {
        ...
        "calcPath": "29. 순두부 르뱅쿠키_완/calculator/index.html",
        "categories": [
            "gift",
            "teatime",
            "cloud"
    ...
    },
    {
        ...
        noFlour: false,
        noButter: false,
        oneBowl: true, vol: "VOL. 37", img: "37. 순두부녹차요거트파운드케익_완/0.jpg", path: "37. 순두부녹차요거트파운드케익_완/index.html", desc: "쌉싸름한 녹차와 산뜻한 요거트가 빚어내는 싱그러운 구움과자" }
        ]
    },
    {
        id: 'halloween',
        ...
        "categories": ["gift", "cloud"],
        "time": "45분",
        "desc": "독일 전통 겨울 디저트 슈톨렌을 비건 스타일로 재해석하여 버터 없이 완성한 고소하고 쫀득한 웰빙 브레드.",
        "emotionalQuote": "하루하루 크리스마스를 기다리며 한 조각씩 썰어 즐기는 웰빙 슈톨렌. 🎄",
        "troubleShoot": "Q. 슈톨렌 겉면의 슈가파우더가 쉽게 녹아버려요!<br>A. [수분 방지 팁] 빵을 완전히 식힌 후 슈가파우더를 도톰하게 뿌려주어야 녹지 않습니다."
    },
    {
        "id": 20,
        "title": "투톤 순두부 타르트",
        ...
        "blogUrl": "",
        "categories": ["teatime", "creamy", "flourfree", "butterfree"],
        "time": "45분",
        "desc": "고소한 비건 타르트지에 부드러운 순두부 초코크림과 화이트크림을 투톤으로 채운 고급 타르트.",
        "emotionalQuote": "두 가지 색의 크림이 조화를 이루는 눈으로 먹는 웰빙 타르트. 🎨",
        "troubleShoot": "Q. 타르트지가 너무 쉽게 부서져요!<br>A. [타르트 성형 팁] 오븐에서 꺼낸 직후에는 무르므로 타르트 틀째로 충분히 식힌 뒤 분리해야 부서지지 않습니다."
    },
    {
        "id": 18,
        "title": "순두부 단호박 찹쌀빵",
    ...
    4: [
        ...
        { time: "5분", title: "믹서 블렌딩", desc: "믹서기에 달걀, 설탕, 물기 있는 그대로의 순두부, 그리고 식혀둔 초콜릿 녹인 혼합물을 모두 넣고 30~40초간 균일하게 갈아냅니다." },
        { time: "5분", title: "머핀 반죽 완성", desc: "액체 혼합물을 큰 볼에 담고 코코아 파우더, 아몬드 가루, 박력분, 베이킹파우더, 소금을 체 쳐 넣어 주걱으로 날가루가 보이지 않을 때까지만 섞어줍니다." },
        { time: "20분", title: "머핀 굽기 & 냉각", desc: "머핀 틀에 반죽을 80% 정도 채우고 170℃ 오븐에서 18~20분간 구워냅니다. 꺼내서 식힘망에서 완전히 식혀줍니다." },
        { time: "10분", title: "크림치즈 프로스팅", desc: "실온의 부드러운 크림치즈에 슈가파우더를 섞어준 후, 차가운 생크림과 바닐라 익스트랙을 부어 단단하고 묵직한 크림 상태가 될 때까지 중속으로 휘핑합니다." },
        { time: "15분", title: "눈꽃 데코 & 마감", desc: "녹인 화이트 초콜릿을 짤주머니에 넣어 유산지 위에 눈 결정 모양을 그려 냉장고에서 굳힌 후, 컵케이크 위에 프로스팅 크림을 짜고 눈결정 초콜릿과 스프링클로 눈꽃을 올립니다." }
    ]
};

// 5. 기본 조리법 템플릿
const DEFAULT_RECIPE_STEPS = [
    { time: "15분", title: "반죽 혼합 및 물성 조율", desc: "계량 배합비에 맞춰 순두부 베이스와 다른 재료들을 볼에 담고, 결이 하나로 균일해질 때까지 정성껏 믹싱합니다." },
            },
            {
                "name": "바닐라 익스트랙",
                "base": 2
