...
console.log('--- Initiating Perfect Reconstruct Engine v11.0 (Backtracking JSON Parser) ---');
...
function lenientParseJSON(str) {
    ...
    // Backtrack from end of string to find parsed array subset
