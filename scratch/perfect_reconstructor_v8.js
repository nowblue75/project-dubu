...
console.log('--- Initiating Perfect Reconstruct Engine v8.0 (No-Filter View Parser) ---');
                ...
                log.tool_calls.forEach(call => {
                    ...
                    if (toolName === 'write_to_file' && call.args?.CodeContent) {
                        ...
                        try {
                            ...
                            console.log(`[Step ${stepIndex}] Skipped MULTI_REPLACE due to truncation/parse error: ${chunkErr.message}`);
                        }
                    }
                });
            }
