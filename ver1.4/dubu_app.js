        ...
        <div id="focus-modal-board" class="atelier-focus-board magic-book-theme" style="
            ...
            <div class="focus-stage-left">
                ...
                <div class="focus-img-wrapper" style="height:62%; margin-top:20px; border-radius:14px; overflow:hidden; box-shadow:0 8px 24px rgba(0,0,0,0.5);">
                    <img src="${encodeURI(recipe.img.startsWith('/') ? recipe.img.slice(1) : recipe.img)}" alt="${recipe.title}" style="width:100%; height:100%; object-fit:cover;" onerror="this.onerror=null; this.src='assets/default_dubu.jpg'">
                </div>
...
function renderArtbookMainGrid(viewer, activePhotobooks) {
    ...
    sortedProjects.forEach(p => {
        ...
        if (isActive) {
            ...
            imgUrl = encodeURI(`${matchedDir}/화보집/${images[0]}`);
...
function openArtbookSlider(cardEl, recipeId, folderName, images) {
    ...
    sliderOverlay.innerHTML = `
        <div class="artbook-slider-container">
            ...
            <div class="artbook-slide-item active" data-slide="1" style="background-image: url('${encodeURI(`${folderName}/화보집/${images[0]}`)}'); background-color: ${bgColor};">
                <img src="${encodeURI(`${folderName}/화보집/${images[0]}`)}" class="mobile-artbook-img" alt="">
            </div>
            <div class="artbook-slide-item" data-slide="2" style="background-image: url('${encodeURI(`${folderName}/화보집/${images[1]}`)}'); background-color: ${bgColor};">
                <img src="${encodeURI(`${folderName}/화보집/${images[1]}`)}" class="mobile-artbook-img" alt="">
            </div>
            <div class="artbook-slide-item" data-slide="3" style="background-image: url('${encodeURI(`${folderName}/화보집/${images[2]}`)}'); background-color: ${bgColor};">
                <img src="${encodeURI(`${folderName}/화보집/${images[2]}`)}" class="mobile-artbook-img" alt="">
            </div>
